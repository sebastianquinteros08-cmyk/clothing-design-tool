"""Prendas de ejemplo canónicas, compartidas por tests y seed.

PLACEHOLDER: las medidas corporales no son reales — setear las del usuario
antes de producir un tech pack.
"""
